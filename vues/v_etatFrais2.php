...
<h3>Fiche de frais du mois <?php echo $numMois."- ".$numAnnee?> : 
    ...
    <input disabled="disabled" id="annuler" type="reset" value="Annuler" size="20" />';} ?>
        ...
        <div class="piedForm"><form>
            <table class="listeLegere"><form method="POST" action="index.php?uc=validFrais&action=validerJustificatifs"><?php $mois=$numAnnee.$numMois ; $mois= str_replace(' ', '', $mois);  $idVisiteur= str_replace(' ', '', $idVisiteur); ?>
  	   ...
  	   <caption>Descriptif des éléments hors forfait -<?php echo '<input id="nb" size="1" type="text" value="'.$nbJustificatifs.'"/>';?> justificatifs reçus -<input id="ok" type="submit" value="Valider" size="1" /></form></div>
       </caption>
             <tr>
